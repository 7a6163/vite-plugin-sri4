...
//
// `SriHashAlgorithm` is derived from this list rather than spelled out a second
// time, so the runtime check and the published type cannot drift apart.
export const SUPPORTED_HASH_ALGORITHMS = ['sha256', 'sha384', 'sha512'] as const
